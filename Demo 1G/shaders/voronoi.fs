...
vec4 voronoif(void) {
  ...
  /*EFFET D'ASPIRATION*/
  if (tmp >= 181556-171019)
  /*ON FAIT tmp-(181556-171019) POUR SE METTRE EN POSITION INITIALE (TMP = 0)*/
    distance += abs(cos((tmp-(181556-171019))/14000)*2) * abs(sin((tmp-(181556-171019))/14000)*2);
